...
class TestLineup:
    def test_fourteen_competitors_with_unique_stable_identities(self) -> None:
        assert len(LINEUP) == 14
        bot_ids = [spec.bot_id for spec in LINEUP]
        assert len(set(bot_ids)) == 14
